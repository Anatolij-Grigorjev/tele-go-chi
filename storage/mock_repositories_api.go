...
// Source: storage/repositories_api.go
//
// Generated by this command:
//
//	mockgen -build_flags=-mod=mod -source=storage/repositories_api.go -destination=storage/mock_repositories_api.go -package=storage
//
